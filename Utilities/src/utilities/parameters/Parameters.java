...
public class Parameters {
	 ...
	 * 
	 * Uses a {@link LinkedHashMap} to guarantee the insertion order when iterating over the map which is needed for the ordered export of the
	 * parameters (see {@link SimulationParametersExporter}).
	 */
	...
	/**
	 * Sets a parameter value for a parameter name. If a value for the name already exists, the old value is replaced. Empty parameter names or
	 * parameter names/values that are <code>null</code> are not valid and thus lead to an {@link IllegalArgumentException}.
	 * 
	 * @param parameterName
	 *            the name of the parameter
	 * @param parameterValue
	 *            the value of the parameter
	 * @return <code>true</code> if the parameter did not already exist, <code>false</code> otherwise
	 * @throws IllegalArgumentException
	 *             If the <code>parameterName</code> is empty or <code>null</code> or if the <code>parameterValue</code> is <code>null</code>
	 */
	public boolean setParameter(String parameterName, Object parameterValue) {
		if (parameterName == null || parameterName.isEmpty() || parameterValue == null)
			throw Parameters.LOG.throwing(new IllegalArgumentException("Invalid parameter name ('" + parameterName + "') or parameter value ('"
					+ parameterValue + "')! The parameter name must not be null or empty and the parameter value must not be null!"));
		if (this.parameters.containsKey(parameterName))
	...
	/**
	 * Checks if the parameter with the given parameter name is available, i.e., checks if there is an entry in the parameters map with the given
	 * parameter name.
	 * 
	 * @param parameterName
	 *            the name of the parameter to check
	 * @return <code>true</code> if there already exists a parameter with the given parameter name, <code>false</code> if not
	 */
	...
	/**
	 * Adds, i.e., merges, the given {@link Parameters} with <code>this</code>. Already existing parameters with the same name are replaced.
	 * 
